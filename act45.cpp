...
int validarNumeroPositivo(int &numero) {
    while (numero < 0) {
        cout << "No se pueden ingresar numeros negativos, intentelo nuevamente: ";
        cin >> numero;
    }
    return numero;
}

float validarNumeroPositivo(float &numero) {
    while (numero < 0) {
        cout << "No se pueden ingresar numeros negativos, intentelo nuevamente: ";
        cin >> numero;
    }
    ...
    do {
        ...
        if (strcmp(nombre, "alejandro") == 0 && strcmp(contra, "2b12") == 0) {
            ...
            do {
                ...
                cin >> av;
                validarNumeroPositivo(av);

                cout << "Precio unitario: ";
                cin >> pu;
                validarNumeroPositivo(pu);
